...
const Forms=["Ime","Prezime","Adresa 1: Grad, Ulica, poštanski broj","Adresa 2: kućni broj, ulaz, kat, ...","E-mail","Kontakt broj"]
        ...
        <div className={styles.info}>
            ...
            <div className={styles.payment} >
                ...
                <label className={styles.container} >
                    <input type="radio" name="radio" />
                    <span className={styles.checkmark} ></span>
                    <img src={paypal} height={"50px"} style={{padding: "0 12px"}} />
                </label>
                <input placeholder={"Broj Kartice\t\t\t\t\tMM/YY\t    CVC"} className={styles.inputfield}  style={{minWidth:"100%"}} />
